...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    private void processCustomMessage(Context context, Bundle bundle) {
        ...
        try {
            ...
            if (jsonObject.getInt("status")== Config.CODE_FRIEND_LIST_CHANGE){
                UserFriendChangeEvent userFriendChangeEvent =new UserFriendChangeEvent();
                EventBus.getDefault().post(userFriendChangeEvent);
            }
        } catch (JSONException e) {

...
import com.csi0n.searchjob.ui.widget.switchbutton.facebook.rebound.SimpleSpringListener;
...
import com.csi0n.searchjob.ui.widget.switchbutton.facebook.rebound.SpringUtil;
...
public class ToggleButton extends View {
	...
	public void toggle(boolean animate) {
		...
		if(listener != null){
			listener.onToggle(getId(),toggleOn);
		}
	}
	...
	public interface OnToggleChanged{
		 ...
		 * @param on
		 */
		public void onToggle(int id, boolean on);
	}

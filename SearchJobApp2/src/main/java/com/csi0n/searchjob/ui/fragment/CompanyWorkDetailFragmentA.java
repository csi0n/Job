...
public class CompanyWorkDetailFragmentA extends BaseFragment {
    ...
    private View getHeadView() {
        View view = View.inflate(aty, R.layout.view_company_work_detail_head, null);
    ...
    public void setCompanyInforTop(CompanyWorkDetailMainBean companyInforTop) {
        ...
        try {
            ...
            for (int i = 0; i < fulis.length; i++) {
                FuliBean fuliBean = db.selector(FuliBean.class).where("id", "=", fulis[i]).findFirst();

...
import com.csi0n.searchjob.ui.widget.ImgBrowserViewPager;
import com.csi0n.searchjob.ui.widget.photoview.PhotoView;
...
public class BrowserViewPagerActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aty_image_browser);
        ...
        mIsGroup = intent.getBooleanExtra(Config.MARK_CHAT_ACTIVITY_IS_GROUP, false);
        if (mIsGroup) {
            mGroupID = intent.getLongExtra(Config.MARK_CHAT_ACTIVITY_GROUP_ID, 0);
            mConv = JMessageClient.getGroupConversation(mGroupID);
        } else {
            mTargetID = intent.getStringExtra(Config.MARK_CHAT_ACTIVITY_TARGET_ID);
        ...
        PagerAdapter pagerAdapter = new PagerAdapter() {
            ...
            public View instantiateItem(ViewGroup container, int position) {
                ...
                else photoView.setImageResource(R.mipmap.ico_friends_sends_pictures_no);
        ...
        if (mFromChatActivity) {
            ...
            if (browserAvatar) {
                ...
                try {
                    ...
                    photoView.setImageResource(R.mipmap.ico_friends_sends_pictures_no);
                }
                //预览聊天界面中的图片
            } else {
                initImgPathList();
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.return_btn:
                    ...
                    setResult(Config.RESULT_CODE_SELECT_PICTURE, intent);
                    finish();
                    break;
            ...
            if (activity != null) {
                switch (msg.what) {
                    ...
                    case 5:
                        ...
                        intent.putExtra(Config.MARK_CHAT_ACTIVITY_SEND_PICTURES, true);
                        ...
                        intent.putExtra(Config.MARK_CHAT_ACTIVITY_MSG_IDS, activity.mMsgIDs);

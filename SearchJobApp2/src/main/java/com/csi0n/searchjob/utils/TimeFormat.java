...
//    }
    ...
    public static String getNearByTime(Context context, java.util.Date data) {

            long currentTime = Configs.getReportTime();
            Date date1 = new Date(currentTime);
            Date date2 = new Date(data.getTime());
            ...
            if (date1.getDate() - date2.getDate() == 0) {
                if (hour < 6)
                    return context.getString(R.string.before_dawn) + " " + date;
                else if (hour < 12)
                    return context.getString(R.string.morning) + " " + date;
                else if (hour < 18)
                    return context.getString(R.string.afternoon) + " " + date;
                else return context.getString(R.string.night) + " " + date;
                //昨天
                ...
                else return context.getString(R.string.sunday);

...
public class PickPictureAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_pick_picture_detail_grid, null);
            viewHolder = new ViewHolder();
            viewHolder.mImageView = (SizeImageView) convertView.findViewById(R.id.child_image);

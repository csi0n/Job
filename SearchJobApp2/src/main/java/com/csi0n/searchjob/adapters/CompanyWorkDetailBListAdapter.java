...
public class CompanyWorkDetailBListAdapter extends BaseAdapter {
    ...
    public List<CompanyWorkDetailBListBean.CompanyWorkDetailBean> datas;
    ...
    @Override
    public CompanyWorkDetailBListBean.CompanyWorkDetailBean getItem(int i) {
        return datas.get(i);
    }
    ...
    public View getView(int positon, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = View.inflate(mCompanyWorkDetailFragmentB.aty, R.layout.view_company_work_detail_b_list_item, null);

...
public class ChooseCityController extends BaseController implements BDLocationListener, LetterListView.OnTouchingLetterChangedListener {
    ...
    public ArrayList<CityModel> city_hot;
    ...
    public ChooseCityController(ChooseCityActivity mChooseCityActivity) {
    ...
    private void getResultCityList(String keyword) throws DbException {
        List<CityModel> cities = db.selector(CityModel.class).where("pinyin", "LIKE", "%" + keyword + "%").findAll();
    ...
    private void setAdapter(List<CityModel> list, List<CityModel> hotList,
                            List<String> hisCity) {
        adapter = new ChooseCityListAdapter(this, mChooseCityActivity, list, hotList, hisCity);
        mChooseCityActivity.personList.setAdapter(adapter);
    }
    private List<CityModel> getCityListFromLocal() throws DbException {
        return db.selector(CityModel.class).findAll();
    }
    ...
    public void hotCityInit() throws DbException {
        List<CityModel> cities = db.selector(CityModel.class).findAll();
    ...
    private Comparator comparator = new Comparator<CityModel>() {
        @Override

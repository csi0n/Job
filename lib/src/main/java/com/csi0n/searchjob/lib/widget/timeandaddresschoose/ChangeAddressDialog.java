package com.csi0n.searchjob.lib.widget.timeandaddresschoose;
...
import com.csi0n.searchjob.lib.widget.timeandaddresschoose.adapter.AbstractWheelTextAdapter;
import com.csi0n.searchjob.lib.widget.timeandaddresschoose.views.OnWheelChangedListener;
import com.csi0n.searchjob.lib.widget.timeandaddresschoose.views.OnWheelScrollListener;
import com.csi0n.searchjob.lib.widget.timeandaddresschoose.views.WheelView;
...
public class ChangeAddressDialog extends Dialog implements View.OnClickListener {
	...
	public ChangeAddressDialog(Context context) {
		super(context, R.style.style_time_address_choose);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.view_dialog_timeandaddress_address);
	...
	private class AddressTextAdapter extends AbstractWheelTextAdapter {
		...
		protected AddressTextAdapter(Context context, ArrayList<String> list, int currentItem, int maxsize, int minsize) {
			super(context, R.layout.view_adapter_item_birth_year, NO_RESOURCE, currentItem, maxsize, minsize);
			this.list = list;

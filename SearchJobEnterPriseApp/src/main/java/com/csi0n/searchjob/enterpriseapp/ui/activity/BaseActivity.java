...
import com.csi0n.searchjob.enterpriseapp.ui.fragment.BaseFragment;
...
public abstract class BaseActivity extends FragmentActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!"com.csi0n.searchjob.enterpriseapp".equals(getApplication().getPackageName()))
